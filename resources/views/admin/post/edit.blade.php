...
@section('content')
    ...
    <form class="layui-form" action="" style="width: 900px;" id="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sub_title" placeholder="请输入文章副标题"
                       autocomplete="off" class="layui-input" value="{{ $post->sub_title }}">
            </div>
        </div>
        <div class="layui-form-item" style="width: 400px;
        @if(!$post->photo)
        ...
        @endif
            ...
            <div class="layui-input-block">
                <img src="{{ $post->photo }}" alt="" id="view_img" style="width: 200px;">
            </div>
        </div>
        <div class="layui-form-item" style="width: 400px;">
            ...
            <div class="layui-input-block">
                ...
                <input type="hidden" name="photo" id="src" value="{{ $post->photo }}">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">摘要</label>
            <div class="layui-input-block">
                <textarea name="summary" placeholder="请输入摘要" class="layui-textarea">{{ $post->summary }}</textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
